...
// SentryOptions options used to configure the Sentry client
...
// NewSentry returns a function that satisfies echo.HandlerFunc interface
// It can be used with Use() methods.
func NewSentry(options SentryOptions) echo.MiddlewareFunc {
